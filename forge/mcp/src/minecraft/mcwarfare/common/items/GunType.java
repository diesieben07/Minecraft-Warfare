...
public enum GunType {
	...
	//ShotGuns
	AA12("AA12", 0, 10, 0, 0, 0, 0),
	KSG("KSG", 0, 10, 0, 0, 0, 0),
	USAS("USAS", 0, 10, 0, 0, 0, 0),
	SPAS12("SPAS12", 0, 10, 0, 0, 0, 0),
	//Snipers
	SKS("SKS", 0, 10, 0, 0, 0, 0),
	SVD("SVD", 0, 10, 0, 0, 0, 0),
	L118A("L118A", 0, 10, 0, 0, 0, 0),
	M95("M95", 0, 10, 0, 0, 0, 0),
	AS50("AS50", 0, 10, 0, 0, 0, 0),
	//Carabines
	M4A1("M4A1", 0, 10, 0, 0, 0, 0),
    SCARH("SCARH", 0, 10, 0, 0, 0, 0),
    G36C("G36C", 0, 10, 0, 0, 0, 0),
    SIG552("SIG552", 0, 10, 0, 0, 0, 0),
    A91("A91", 0, 10, 0, 0, 0, 0),
	//Pistols
    MAGNUM("MAGNUM", 0, 10, 0, 0, 0, 0),
    DESERTEAGLE("DESERTEAGLE", 0, 10, 0, 0, 0, 0),
    G18("G18", 0, 10, 0, 0, 0, 0),
    G17("G17", 0, 10, 0, 0, 0, 0),
    MP412("MP412", 0, 10, 0, 0, 0, 0),
    USP("USP", 0, 10, 0, 0, 0, 0),
	//SMG
	...
	M60("M60", 0, 10, 0, 0, 0, 0),
	RPK("RPK", 0, 10, 0, 0, 0, 0),
	M249("M249", 0, 10, 0, 0, 0, 0),
	PKP("PKP", 0, 10, 0, 0, 0, 0);
